...
static mp_obj_t esp32_rmt_stop_read_pulses(mp_obj_t self_in) {
    // esp32_rmt_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
static MP_DEFINE_CONST_FUN_OBJ_1(esp32_rmt_stop_read_pulses_obj, esp32_rmt_stop_read_pulses);


static mp_obj_t esp32_rmt_read_pulses(mp_obj_t self_in) {
    // esp32_rmt_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
static MP_DEFINE_CONST_FUN_OBJ_1(esp32_rmt_read_pulses_obj, esp32_rmt_read_pulses);
...
static const mp_rom_map_elem_t esp32_rmt_locals_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_read_pulses), MP_ROM_PTR(&esp32_rmt_read_pulses_obj) },
    { MP_ROM_QSTR(MP_QSTR_stop_read_pulses), MP_ROM_PTR(&esp32_rmt_stop_read_pulses_obj) },
};
